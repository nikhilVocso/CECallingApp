...
function WithdrawalMessageScreen({ from = 3, to = 7, navigation }) {
          ...
          <View style={[{ paddingHorizontal: width * 0.1 }]}>
            ...
            <View style={[styles.bodyContainer]}>
              <AppText style={[styles.text]}>
                Your request has been submitted. Usually it takes {from}-{to}{" "}
                business days to process withdrawal request.
              </AppText>
...
export default WithdrawalMessageScreen;
